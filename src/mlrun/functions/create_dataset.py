...
def create_dataset(context: mlrun.MLClientCtx, workload_id: str, client_id: str):
    """
    ...
    :return: A dictionary containing the workload ID, flywheel run ID, client ID, workload type, and created datasets.
    """
    result = create_datasets(context, workload_id=workload_id, client_id=client_id)
